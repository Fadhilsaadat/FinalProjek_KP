              ...
              <div>
                ...
                <form action="<?= route_to('register') ?>" method="post">
                  ...
                  <div class="form-outline mb-3">
                    <input type="text" placeholder="Masukkan nama" name="fullname" class="form-control form-control-lg fs-6 <?php if (session('errors.fullname')) : ?>is-invalid<?php endif ?>" value="<?= old('fullname') ?>" />
