...
<section class="hero">
    <?php if (in_groups('user')) { ?>
        <form action="<?php echo base_url('pengajuan/store'); ?>" method="post">
            <div class="row justify-content-between me-auto col-auto">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <!-- <div class="form-group mb-3">
                        <label for="penanggung_jawab" class="mb-2">Penanggung Jawab</label>
                        <input type="text" name="penanggung_jawab" class="form-control" required>
                    </div> -->
                        <div class="form-group mb-3">
                            <label for="orang_terlibat" class="mb-2">Orang Terlibat</label>
                            <input type="text" name="orang_terlibat" class="form-control" value="<?= @old("orang_terlibat") ?>" required>
                        </div>
                        <div class="form-group mb-3">
